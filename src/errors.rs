...
impl PartialEq for VestaboardError {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (VestaboardError::ReqwestError { context: c1, .. }, VestaboardError::ReqwestError { context: c2, .. }) => c1 == c2,
            (VestaboardError::WidgetError { widget: w1, message: m1 }, VestaboardError::WidgetError { widget: w2, message: m2 }) => w1 == w2 && m1 == m2,
            (VestaboardError::ScheduleError { operation: o1, message: m1 }, VestaboardError::ScheduleError { operation: o2, message: m2 }) => o1 == o2 && m1 == m2,
            (VestaboardError::ApiError { code: c1, message: m1 }, VestaboardError::ApiError { code: c2, message: m2 }) => c1 == c2 && m1 == m2,
            (VestaboardError::ConfigError { field: f1, message: m1 }, VestaboardError::ConfigError { field: f2, message: m2 }) => f1 == f2 && m1 == m2,
